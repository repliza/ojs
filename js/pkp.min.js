...
a.html(c.content);"0"==c.content?a.removeClass("hasTasks"):a.addClass("hasTasks")}})(jQuery);(function(a){a.pkp.pages.submission=a.pkp.pages.submission||{};a.pkp.pages.submission.SubmissionTabHandler=function(a,c){this.parent(a,c);this.submissionSteps_=c.submissionSteps;this.submissionProgress_=c.submissionProgress;this.cancelUrl_=c.cancelUrl;this.cancelConfirmText_=c.cancelConfirmText;this.bind("setStep",this.setStepHandler);this.bind("formCanceled",this.formCanceledHandler);this.getHtmlElement().tabs("option","disabled",this.getDisabledSteps(this.submissionSteps_,this.submissionProgress_))};
a.pkp.classes.Helper.inherits(a.pkp.pages.submission.SubmissionTabHandler,a.pkp.controllers.TabHandler);a.pkp.pages.submission.SubmissionTabHandler.prototype.submissionSteps_=null;a.pkp.pages.submission.SubmissionTabHandler.prototype.submissionProgress_=null;a.pkp.pages.submission.SubmissionTabHandler.prototype.cancelUrl_=null;a.pkp.pages.submission.SubmissionTabHandler.prototype.cancelConfirmText_=null;a.pkp.pages.submission.SubmissionTabHandler.prototype.setStepHandler=function(a,c,d){this.getHtmlElement().tabs("option",
"disabled",this.getDisabledSteps(this.submissionSteps_,d));a=parseInt(d,10);a=this.submissionSteps_.indexOf(a);this.getHtmlElement().tabs("option","active",a)};a.pkp.pages.submission.SubmissionTabHandler.prototype.formCanceledHandler=function(a,c,d){confirm(this.cancelConfirmText_)&&(window.location=this.cancelUrl_)};a.pkp.pages.submission.SubmissionTabHandler.prototype.getDisabledSteps=function(a,c){var b=parseInt(c,10),e=null;c=[];if(0==b)return[];0<a.length&&(e=a[a.length-1]);if(b==e)return[];
b=a.indexOf(b);if(-1!=b){for(b+=1;b<a.length;++b)c.push(b);return c}throw Error("Illegal submission step number!");}})(jQuery);jQuery.pkp.pages.submission=jQuery.pkp.pages.submission||{};
